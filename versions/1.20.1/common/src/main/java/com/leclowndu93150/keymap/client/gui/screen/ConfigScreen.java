...
public class ConfigScreen extends EScreen2 {
    ...
    protected void onInit() {
        ...
        ELabel2 labelTooltips = new ELabel2(
                Component.translatable("keymap.catTooltips").withStyle(bold), scr.left(), scr.top() + h * 4, scr.w(), h);
        ...
        ELineToggleButton toggleMad = new ELineToggleButton(
                Component.translatable("keymap.optCrashOnProblematicError"), scr.left(), scr.top() + h * 10, scr.w(), h);
    ...
    @Override
    protected void preRender(GuiGraphics graphics, int mouseX, int mouseY, float a) {
        super.preRender(graphics, mouseX, mouseY, a);
    }

    @Override
    protected void postRender(GuiGraphics graphics, int mouseX, int mouseY, float a) {}
