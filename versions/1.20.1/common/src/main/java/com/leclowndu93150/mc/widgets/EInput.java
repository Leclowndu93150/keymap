...
public class EInput extends EWidget {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float a) {
        ...
        if (!display.isEmpty()) {
            graphics.drawString(font, display, left() + padding.x(), top() + padding.y(), colorVariant().text());
        } else {
            graphics.drawString(font, placeholder, left() + padding.x(), top() + padding.y(), color.disabled().text());
        }
