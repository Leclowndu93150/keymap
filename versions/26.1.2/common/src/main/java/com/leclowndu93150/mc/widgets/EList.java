...
public abstract class EList<T extends EList.EListEntry<T>> extends EWidget {
    ...
    protected void renderList(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
    ...
    public abstract static class EListEntry<T extends EListEntry<T>> implements Tooltipped {
        ...
        public void render(GuiGraphicsExtractor graphics, Rect r, float a) {
        ...
        public abstract void renderWidget(GuiGraphicsExtractor graphics, Rect r, float a);
    }
}
