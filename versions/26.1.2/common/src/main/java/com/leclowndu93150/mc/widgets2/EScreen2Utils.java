...
public abstract class EScreen2Utils extends Screen {
    ...
    protected void drawOutline(GuiGraphicsExtractor graphics, int l, int t, int r, int b, int c) {
        U.outline(graphics, l, t, r, b, c);
    }

    protected void drawOutline(GuiGraphicsExtractor graphics, Rect r, int c) {
        drawOutline(graphics, r.left(), r.top(), r.right(), r.bottom(), c);
    }

    protected void drawOutline(GuiGraphicsExtractor graphics, int c) {
        drawOutline(graphics, scr, c);
    }

    protected void drawOutsideOutline(GuiGraphicsExtractor graphics, Rect r, int c) {
        drawOutline(graphics, r.left() - 1, r.top() - 1, r.right() - 1, r.bottom() - 1, c);
    }

    protected void drawOutsideOutline(GuiGraphicsExtractor graphics, int c) {
